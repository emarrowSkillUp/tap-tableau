...
`tap-tableau` is a Singer tap for tableau.
...
```bash
pipx install tap-tableau
```

Install from GitHub:

```bash
pipx install git+https://github.com/ORG_NAME/tap-tableau.git@main
```
...
```
tap-tableau --about --format=markdown
```
-->
